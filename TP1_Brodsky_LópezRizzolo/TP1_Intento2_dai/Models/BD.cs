...
using Dapper;
using TP1_Intento2_dai.Models;

namespace TP1_Intento2_dai.Models;

public static class BD{

    private static string CONNECTION_STRING = @"Server=COMPU-AGUS\SQLEXPRESS01;DataBase=BDPizzas;Trusted_Connection=True;";
